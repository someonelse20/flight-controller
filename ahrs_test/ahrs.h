...
typedef struct settings_s {
  ...
  float accel_rejection; // Acceleration in g that the accelerometer should be
                         // considered unreliable.
  float
      accel_rejection_t; // Time in secconds that acceleration > accel_rejection
                         // after which the accelerometer will be rejected.
